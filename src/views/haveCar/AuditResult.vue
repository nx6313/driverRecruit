<template>
  <div class="auditResult">
    ...
    <div v-if="!isAuditing" class="userHasAudit">
      ...
      <router-link v-if="$store.state.driverRecruit.state == $store.state.driverRecruit.stateRule.INTERVIEW_PASS" to="/haveCar/baseInfo1" class="againCommit" tag="span" replace>返回重新修改相关信息</router-link>
    </div>
  </div>
</template>
